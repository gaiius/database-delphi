...
Begin VB.Form frmLapRincian 
   ...
   End
End
Attribute VB_Name = "frmLapRincian"
...
If Option1.Value = True Then
    ...
    rs.Open "SELECT * FROM VIEW_LAP_RINCIAN_BIAYA WHERE NIK='" & Trim(cbo_NIK.Text) & "'", cn, 1, 2
    If rs.EOF Then
    ...
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Rincian_Biaya.rpt"
        .ReportTitle = "Laporan Berdasarkan NIK"
        .WindowState = crptMaximized
        .SelectionFormula = "{VIEW_LAP_RINCIAN_BIAYA.NIK}='" & Trim(cbo_NIK.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option2.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM VIEW_LAP_RINCIAN_BIAYA WHERE year(tgl_rincian)='" & Trim(cbo_Kawin.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        .LogOnServer "p2ssql.dll", "KRAMOTAX", "db_euis_ta", "sa", "sa"
        .ReportFileName = App.Path & "\Lap_Rincian_Biaya.rpt"
        .ReportTitle = "Laporan Berdasarkan Tahun " & cbo_Kawin.Text
        .WindowState = crptMaximized
        .SelectionFormula = "year({VIEW_LAP_RINCIAN_BIAYA.tgl_rincian})= " & Trim(cbo_Kawin.Text) & " "
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option3.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM VIEW_LAP_RINCIAN_BIAYA WHERE divisi='" & Trim(cbo_Divisi.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        .LogOnServer "p2ssql.dll", "KRAMOTAX", "db_euis_ta", "sa", "sa"
        .ReportFileName = App.Path & "\Lap_Rincian_Biaya.rpt"
        .ReportTitle = "Laporan Berdasarkan Divisi " & cbo_Divisi.Text
        .WindowState = crptMaximized
        .SelectionFormula = "{VIEW_LAP_RINCIAN_BIAYA.divisi}='" & Trim(cbo_Divisi.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option4.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM VIEW_LAP_RINCIAN_BIAYA WHERE jabatan='" & Trim(cbo_jab.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        .LogOnServer "p2ssql.dll", "KRAMOTAX", "db_euis_ta", "sa", "sa"
        .ReportFileName = App.Path & "\Lap_Rincian_Biaya.rpt"
        .ReportTitle = "Laporan Berdasarkan Jabatan " & cbo_jab.Text
        .WindowState = crptMaximized
        .SelectionFormula = "{VIEW_LAP_RINCIAN_BIAYA.jabatan}='" & Trim(cbo_jab.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
