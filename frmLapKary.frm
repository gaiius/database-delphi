...
If Option1.Value = True Then
    ...
    rs.Open "SELECT * FROM view_karyawan WHERE NIK='" & Trim(cbo_NIK.Text) & "'", cn, 1, 2
    If rs.EOF Then
    ...
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Karyawan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_karyawan.NIK}='" & Trim(cbo_NIK.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option2.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM view_karyawan WHERE status_kawin='" & Trim(cbo_Kawin.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Karyawan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_karyawan.status_kawin}='" & Trim(cbo_Kawin.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option3.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM view_karyawan WHERE divisi='" & Trim(cbo_Divisi.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Karyawan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_karyawan.divisi}='" & Trim(cbo_Divisi.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option4.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM view_karyawan WHERE jabatan='" & Trim(cbo_jab.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Karyawan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_karyawan.jabatan}='" & Trim(cbo_jab.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
