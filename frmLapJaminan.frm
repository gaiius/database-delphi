...
Begin VB.Form frmLapJaminan 
   ...
   End
End
Attribute VB_Name = "frmLapJaminan"
...
If Option1.Value = True Then
    ...
    rs.Open "SELECT * FROM view_Jaminan WHERE NIK='" & Trim(cbo_NIK.Text) & "'", cn, 1, 2
    If rs.EOF Then
    ...
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Jaminan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_Jaminan.NIK}='" & Trim(cbo_NIK.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option2.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM view_Jaminan WHERE th_anggaran='" & Trim(cbo_Kawin.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Jaminan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_Jaminan.th_anggaran}='" & Trim(cbo_Kawin.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option3.Value = True Then
    Set rs = New ADODB.Recordset
    rs.Open "SELECT * FROM view_Jaminan WHERE divisi='" & Trim(cbo_Divisi.Text) & "'", cn, 1, 2
    If rs.EOF Then
        MsgBox "Maaf, tidak ada data yang diCetak", vbInformation, "Info"
        Exit Sub
    Else
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Jaminan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_Jaminan.divisi}='" & Trim(cbo_Divisi.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
...
ElseIf Option4.Value = True Then
    ...
    With CrystalReport1
        ...
        .ReportFileName = App.Path & "\Lap_Jaminan.rpt"
        .WindowState = crptMaximized
        .SelectionFormula = "{view_Jaminan.jabatan}='" & Trim(cbo_jab.Text) & "'"
        .RetrieveDataFiles
        .Action = 1
        .Reset
    End With
